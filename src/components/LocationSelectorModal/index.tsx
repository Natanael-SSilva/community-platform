...
import { View, Text, Modal, TextInput, FlatList, TouchableOpacity, ActivityIndicator } from 'react-native';
...
const LocationSelectorModal = ({ visible, onClose, onLocationSelect }: Props) => {
