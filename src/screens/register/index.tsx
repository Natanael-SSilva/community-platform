...
const RegisterScreen: React.FC = () => {
    ...
    const handleSignUp = async () => {
        ...
        if (!usernameRegex.test(username)) {
            setError("Nome de usuário pode conter apenas letras e números, sem espaços.");
            return;
        }
            ...
            >
                ...
                >
                    <View style={styles.headerContainer}>
                        ...
                        <Text style={styles.subtitle}>Comece a se conectar com sua comunidade.</Text>
                    </View>
                    ...
                    <View style={styles.formContainer}>
                        ...
                        <View style={styles.inputContainer}>
                            ...
                            <TouchableOpacity onPress={() => setIsConfirmPasswordVisible(!isConfirmPasswordVisible)}>
                                <Ionicons name={isConfirmPasswordVisible ? "eye-off" : "eye"} size={24} color="#A0AEC0" style={styles.icon} />
                            </TouchableOpacity>
                        </View>
                    </View>
